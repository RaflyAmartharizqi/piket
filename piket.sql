...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Apr 2020 pada 05.07
...
INSERT INTO `guru_piket` (`id`, `nama_guru`, `alamat`, `telp`, `id_users`, `created_at`, `update_at`) VALUES
('0000-00-00 00:00:00', 'Tukiyem', 'Ujik', '0812349999', 0, NULL, NULL);
...
(1, 'Kumpik', '12345678', 'PinggirKali', '0898989', NULL, NULL);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `siswa` (`id`),
  ADD CONSTRAINT `users_ibfk_2` FOREIGN KEY (`id`) REFERENCES `guru_piket` (`id_users`);
COMMIT;
